...
class TestQuizPlanner:
    ...
    def test_cold_start_is_detected(self):
        ...
        """
        with patch("agents.quiz.planner._get_all_topic_tracking") as mock_track, \
    ...
    def test_output_has_all_required_keys(self):
        ...
        required = {
            "topics", "cluster", "total_questions",
            "difficulty_target", "format_distribution",
            "new_topics", "review_topics",
            "is_cold_start", "accessible_topics",
        }
    ...
    def test_prerequisite_unlocked_when_score_above_threshold(self):
        ...
        accessible = _filter_by_prerequisite(
            ["Present Tenses", "Past Tenses"], topic_tracking
        )
    ...
    def test_cognitive_load_max_1_new_topic(self):
        ...
        accessible = ["Present Tenses", "Subject-Verb Agreement",
